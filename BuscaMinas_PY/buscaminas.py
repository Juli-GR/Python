...
def crea_matriz(w, l):
  ...
  """
  - Esta función creara una matriz a partir de los parametros 
  introducidos. 
...
def pone_bombas():
  ...
  """
  - Esta función se encarga de poner bombas dentro de la matriz.
...
def pone_numeros():	# Los números del 0 al 8 indican la cantidad de bombas cercanas
  ...
  """
  - Esta función nos indica el numero de minas que tenemos 
...
def dibuja_tablero():
  ...
  """
  - Esta función se ocupa de imprimir el tablero por pantalla.
...
def dibuja_casilla(i, j):
  ...
  """
  - Esta función se ocupa de imprimir las casillas 
  dentro del tablero por pantalla.
...
def abrir_vacias (tablero, bomb_num, i, j):
  ...
  """
  - Esta función se ocupa de abrir las celdas que estan vacias es decir
  las que no tienen minas.
